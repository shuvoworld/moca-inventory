...
class Uoms extends Admin_Base_Controller
{
    ...
    public function all_uoms()
    {
        try {
            ...
            $crud = $this->getGroceryCRUD('uoms', 'Uoms', 'Uoms', 'Unit of Measures');

            // data Grid view fields
            $crud->columns('name', 'created_at', 'updated_at', 'created_by', 'updated_by');


            // Insert form
            $crud->add_fields('name', 'created_at', 'updated_at', 'created_by', 'updated_by');

            // Update form
            $crud->edit_fields('name', 'created_at', 'updated_at', 'created_by', 'updated_by');
            ...
            $output = $crud->render();
            $this->load->view('admin/uoms/v_Uoms', (array) $output);
