...
class Suppliers extends Admin_Base_Controller
{
    ...
    public function all_suppliers()
    {
        try {
            ...
            $crud = $this->getGroceryCRUD('suppliers', 'Suppliers', 'Suppliers', 'Manage All Suppliers');

            // data Grid view fields
            $crud->columns('company_name', 'owner_name', 'contact_no', 'email', 'updated_at');


            // Insert form
            $crud->add_fields('company_name', 'owner_name', 'address', 'contact_no', 'email', 'created_at', 'created_by', 'updated_at', 'updated_by');

            // Update form
            $crud->edit_fields('company_name', 'owner_name', 'address', 'contact_no', 'email', 'created_at', 'created_by', 'updated_at', 'updated_by');
            ...
            // Required fields
            $crud->required_fields('company_name', 'owner_name', 'contact_no');

            // Rename field level
            $crud->display_as('company_name', ' Company')
                ->display_as('owner_name', ' Owner\'s Name')
                ->display_as('contact_no', ' Mobile')
