...
class Sections extends Admin_Base_Controller
{
    ...
    {
        redirect('admin/sections/all_sections/');
    }
    ...
    public function all_sections()
    {
        try {
            ...
            $crud = $this->getGroceryCRUD('sections', 'Sections', 'Sections', 'Manage All Sections');

            // data Grid view fields
            $crud->columns('name', 'contact_no', 'email', 'updated_at');


            // Insert form
            $crud->add_fields('name', 'contact_no', 'email', 'created_at', 'created_by', 'updated_at', 'updated_by');

            // Update form
            $crud->edit_fields('name', 'contact_no', 'email', 'created_at', 'created_by', 'updated_at', 'updated_by');
