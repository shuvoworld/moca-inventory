<?php
class Brands extends Admin_Base_Controller
{
    ...
    {
        $this->data['title'] = 'Manage Product Brands';
        $this->data['breadcrumbs'] = 'Manage brands';
        $this->load->view('admin/brands/manage', $this->data);
    }
    ...
    public function get_all()
    {
        ...
        if ($this->input->is_ajax_request()) {
            $this->data['all'] = $this->brand_model->get_all();
            $view = $this->load->view('admin/brands/all', $this->data, true);
    ...
    public function create_form()
    {
        ...
        if ($this->input->is_ajax_request()) {
            $view = $this->load->view('admin/brands/add', $this->data, true);
            $this->output->set_output($view);
        } else {
            redirect('admin/dashboard');
        }
    ...
    public function create()
    {
        ...
        if ($this->input->is_ajax_request()) {
            ...
            if ($this->form_validation->run() == false) {
                ...
                $results = $this->brand_model->create($insertData);
    ...
    public function edit_form()
    {
        ...
        if ($this->input->is_ajax_request()) {
            ...
            $this->data['single'] = $this->brand_model->get_by_id($id);
            $view = $this->load->view('admin/brands/edit', $this->data, true);
            $this->output->set_output($view);
        } else {
            redirect('admin/dashboard');
        }
    ...
    public function edit()
    {
        ...
        if ($this->input->is_ajax_request()) {
            ...
            if ($this->form_validation->run() == false) {
                ...
                $results = $this->brand_model->edit($updateData, $updateId);
