    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <p class="panel-title">Manage all agencies
...
<!--========================  Modal  section =================-->
<div class="modal fade" id="modalAgency" role="dialog"
...
<script>
    $(document).ready(function () {
        ...
        table = $('#manage_all').DataTable({
            ...
            "ajax": {
                "url": BASE_URL + 'admin/agencies/get_all',
                "type": "POST"
            },
...
<script>
    ...
    function create() {
        ...
        $("#modal_data").empty();
        $('.modal-title').text('Add New Agency'); // Set Title to Bootstrap modal title

        $.ajax({
            type: 'POST',
            url: BASE_URL + 'admin/agencies/create_form',
            success: function (msg) {
                $("#modal_data").html(msg);
                $('#modalAgency').modal('show'); // show bootstrap modal
            },
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#manage_all").on("click", ".edit", function () {
            ...
            $.ajax({
                url: BASE_URL + 'admin/agencies/edit_form',
                type: 'POST',
                data: 'id=' + id,
                success: function (msg) {
                    $("#modal_data").html(msg);
