...
<div class="row">
	<div class="col-md-12">
			...
			<div class="panel-heading">
				<?php if ($this->session->flashdata('success')): ?>
					...
					<?php elseif ($this->session->flashdata('error')): ?>
						...
						<?php endif;?>
						<p class="panel-title">ক্রয় অর্ডার
							<a href="<?php echo base_url('admin/purchases/create_form') ?>" class="btn btn-success" style="color: #FFFFFF"><i class="glyphicon glyphicon-plus"></i>Add Purchase</a>
						</p>
					</div>
		...
		<script>
            ...
            "ajax": {
            	"url": BASE_URL + 'admin/purchases/get_all',
            	"type": "POST"
            },
