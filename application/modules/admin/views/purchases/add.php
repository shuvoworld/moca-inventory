			...
			<div class="panel-heading">
				<div class="panel-body">
					<div class="row">
						...
						<?php endif;?>
						<?php echo form_open('admin/purchases/create', array('id' => 'create_purchase', 'accept-charset' => 'utf-8')); ?>
						<div class="box-body">
							<div class="row">
								...
								<div class="form-group col-md-2 col-sm-12">
									...
									<?php echo form_input(['name' => 'purchase_date', 'id' => 'purchase_date', 'class' => 'form-control datepicker']); ?>
								</div>
							...
							<div class="row">
								<div class="form-group col-md-4 col-sm-12">
									...
									<input type="button" class="btn btn-danger" value="cancel" onClick="window.location.href='<?php echo base_url() . "admin/purchases"; ?>'" />
								</div>
							</div>
							<!-- /.box-body -->
						</form>
