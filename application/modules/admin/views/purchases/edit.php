        ...
        <div class="panel-heading">
          <div class="panel-body">
            <div class="row">
              ...
              <?php endif;?>
              <?php echo form_open('admin/purchases/edit', array('id' => 'edit_purchase', 'accept-charset' => 'utf-8')); ?>
              <div class="box-body">
                <div class="row">

                  <div class="form-group col-md-2 col-sm-12">
                    <label for=""> Supplier </label>
                    <input type="text" class="form-control" id="supplier" name="supplier" readonly  value="<?php echo $supplier; ?>" placeholder="">
                  </div>

                  <div class="form-group col-md-2 col-sm-12">
                    <label for=""> Purchase Date </label>
                    <input type="text" class="form-control" id="purchase_date" name="purchase_date" readonly  value="<?php echo $value['purchase_date']; ?>" placeholder="">
