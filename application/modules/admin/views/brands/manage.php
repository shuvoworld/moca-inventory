    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <p class="panel-title">Manage all brands
...
<script>
    $(document).ready(function () {
        ...
        table = $('#manage_all').DataTable({
            ...
            "ajax": {
                "url": BASE_URL + 'admin/brands/get_all',
                "type": "POST"
            },
...
<script>
    ...
    function create() {
        ...
        $.ajax({
            type: 'POST',
            url: BASE_URL + 'admin/brands/create_form',
            success: function (msg) {
                $("#modal_data").html(msg);
                $('#modalBrand').modal('show'); // show bootstrap modal
            },
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#manage_all").on("click", ".edit", function () {
            ...
            var id = $(this).attr('id');
            $.ajax({
                url: BASE_URL + 'admin/brands/edit_form',
                type: 'POST',
                data: 'id=' + id,
                success: function (msg) {
                    $("#modal_data").html(msg);
