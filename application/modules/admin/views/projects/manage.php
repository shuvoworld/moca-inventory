...
<div class="row">
	<div class="col-md-12">
			...
			<div class="panel-heading">
				<?php if ($this->session->flashdata('success')): ?>
					...
					<?php elseif ($this->session->flashdata('error')): ?>
						...
						<?php endif;?>
						<p class="panel-title">Manage all projects/programs
							<a href="<?php echo base_url('admin/projects/create_form') ?>" class="btn btn-success" style="color: #FFFFFF"><i class="glyphicon glyphicon-plus"></i>Add new Project/Program</a>
						</p>
					</div>
		...
		<script>
            ...
            "ajax": {
            	"url": BASE_URL + 'admin/projects/get_all',
            	"type": "POST"
            },
			dom: 'Bfrtip',
            buttons: [
