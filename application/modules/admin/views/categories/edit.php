...
if ($single) {
	...
	?>
	<form id='edit_category' action="" enctype="multipart/form-data" method="post"
...
<script>
	$(document).ready(function () {
		$('#loader').hide();
		// alert();
		$('#edit_category').validate({// <- attach '.validate()' to your form
			...
			submitHandler: function (form) {
				...
				var myData = new FormData($("#edit_category")[0]);
				...
				$.ajax({
					...
					success: function (data) {
						...
						if (data.type === 'success') {
							...
							$('#modalCategory').modal('hide'); // hide bootstrap modal
