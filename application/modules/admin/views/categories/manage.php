    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <p class="panel-title">Manage all categories
...
<script>
    $(document).ready(function () {
        ...
        table = $('#manage_all').DataTable({
            ...
            "ajax": {
                "url": BASE_URL + 'admin/categories/get_all',
                "type": "POST"
            },
            ...
            buttons: [
                {
                    extend: 'excelHtml5',
                    text: '<i class="fa fa-table"> এক্সেল </i>',
                    titleAttr: 'Excel',
                    exportOptions: {
                ...
                {
                    extend: 'pdfHtml5',
                    text: '<i class="fa fa-file-pdf-o">পিডিএফ</i>',
                    titleAttr: 'PDF',
                    exportOptions: {
                        columns: ':visible'
                    }
                ...
                {
                    extend: 'print',
                    text: '<i class="fa fa-print"> প্রিন্ট </i>',
                    titleAttr: 'Print',
                    exportOptions: {
                        columns: ':visible'
                    }
                ...
                {
                    extend: 'colvis',
                    text: '<i class="fa fa-eye-slash"> কলাম দেখুন </i>',
...
<script>
    ...
    function create() {
        ...
        $.ajax({
            type: 'POST',
            url: BASE_URL + 'admin/categories/create_form',
            success: function (msg) {
                $("#modal_data").html(msg);
                $('#modalCategory').modal('show'); // show bootstrap modal
            },
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#manage_all").on("click", ".edit", function () {
            ...
            var id = $(this).attr('id');
            $.ajax({
                url: BASE_URL + 'admin/categories/edit_form',
                type: 'POST',
                data: 'id=' + id,
                success: function (msg) {
                    $("#modal_data").html(msg);
