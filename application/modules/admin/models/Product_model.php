...
class Product_model extends CI_Model
{
    ...
    {
        $this->db->select('products.id as id, products.name as name, products.stock_available as stock_available, categories.name as category, brands.name as brand, products.model as model, products.updated_at as updated_at')
            ->from($this->_table)
            ->order_by($this->primary_key, 'DESC');
